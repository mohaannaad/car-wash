...
export default function SubscriptionConfirmationPage() {
  ...
  return (
    <main className="min-h-screen flex flex-col items-center bg-bg-page px-6 pt-16 pb-10 gap-6 text-center">
      {/* أيقونة النجاح */}
      ...
      <div className="flex flex-col gap-2">
        ...
        <p className="text-text-secondary text-sm">
          ...
          <span className="font-bold text-text-main">
            {subscription.packageId ? packageNames[subscription.packageId] : "-"}
          </span>{" "}
          شغال دلوقتي
        </p>
      </div>
      ...
      {/* بطاقة المواعيد */}
      <div className="w-full bg-white rounded-2xl p-5 flex flex-col gap-3 shadow-[0_2px_10px_rgba(16,24,40,0.05)]">
      ...
      <Link
        href="/"
        className="w-full max-w-sm mt-4 flex items-center justify-center py-4 rounded-2xl font-bold text-white bg-primary shadow-[0_8px_20px_rgba(25,185,198,0.35)]"
      >
        العودة للرئيسية
      </Link>
    </main>
